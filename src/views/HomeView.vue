  ...
  <div>
    ...
    <v-row>
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card elevation="0" border rounded="xl" class="pa-5 h-100">
          ...
          <div class="text-h4 font-weight-black" style="color: #1a3b5c;">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card elevation="0" border rounded="xl" class="pa-5 h-100">
          ...
          <div class="text-h4 font-weight-black" style="color: #e65100;">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card elevation="0" border rounded="xl" class="pa-5 h-100">
          ...
          <div class="text-h4 font-weight-black" style="color: #2e7d32;">
      ...
      <v-col cols="12" sm="6" md="3">
        <v-card elevation="0" border rounded="xl" class="pa-5 h-100">
          ...
          <div class="text-h4 font-weight-black" style="color: #424242;">
    ...
    <v-card elevation="0" border rounded="xl" class="mt-8">
      ...
      <v-table>
        ...
        <tbody>
          <tr v-for="item in activities" :key="item.id" class="border-b-thin">
            <td class="font-weight-bold text-primary py-4">
              <router-link :to="`/actes/${item.rawId || item.id}`" class="text-primary text-decoration-none font-weight-bold">{{ item.id }}</router-link>
            </td>
            ...
            <td class="text-grey-darken-1 py-4">
              <div class="d-flex align-center">
                <v-icon size="small" color="grey-lighten-1" class="mr-2">mdi-map-marker-outline</v-icon>
                {{ item.parcelle }}
              </div>
            </td>
